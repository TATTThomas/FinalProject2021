...
public class CameraController : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        //transform.RotateAround(player.transform.position, Vector3.zero, rotateVertical * sensitivity); // again, use transform.Rotate(transform.right * rotateVertical * sensitivity) if you don't want the camera to rotate around the player
    }
}
